...
class EditCehicleForm extends Component {
  state = {
    uploading: false,
    fileList: [],
  ...
  render() {
    ...
    const { id, licenseNo, model, trackerId, allDepartments, driverId, carImages, initialMileage } = currentRowData;
         ...
         <Form.Item label="车牌号:">
          ...
          <Form.Item label="司机:">
            {getFieldDecorator("driverId", {
              initialValue: {key: driverId ? driverId : '', label: driverId ? driverId : ''}
            })(
              <Select
                style={{
                  width: 150,
...
export default Form.create({ name: "EditCehicleForm" })(EditCehicleForm);
