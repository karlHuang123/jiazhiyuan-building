...
class EditDeviceModelForm extends Component {
  state = {
        ...
        <Form>
          ...
          <Form.Item label="描述:">
            {getFieldDecorator("description", {
                initialValue: currentRowData ? currentRowData.description : '', 
...
export default Form.create({ name: "EditDeviceModelForm" })(EditDeviceModelForm);
