...
class SystemDeviceProb extends Component {
  state = {
    expandedKeys: [],
    systemName: '',
    problemList: [],
              ...
              <Table 
                ...
                <Column title="规范与条款" ellipsis={true} width={200} key="provisions" align="center" render={(text, row) => (
                  <Tooltip title={row.provisions}>
                    <div style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', width: '165px' }}>{row.provisions}</div>
                  </Tooltip>
                )}/>
...
export default SystemDeviceProb;
