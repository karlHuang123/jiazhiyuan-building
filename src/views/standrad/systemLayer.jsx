...
class SystemLayer extends Component {
  state = {
    layers: [],
    keyword: '',
    layerBody: {},
  ...
  componentDidMount() {
    this.getLayerListFun()
  }
  render() {
    const { layers, keyword } = this.state
    const title = (
