...
class EditContractForm extends Component {
  ...
  render() {
    const { visible, onCancel, onOk, form, confirmLoading, options, currentRowData } = this.props;
    const { getFieldDecorator } = form;
    const { id, client, state, contractFile, contractNo, techServiceFile } = currentRowData;
         ...
         <Form.Item label="委托方id:">
          ...
          <Form.Item label="委托方:">
            {getFieldDecorator(`client[${'type'}]`, {
              ...
              initialValue: {key: client ? client.id : '', label: client ? client.name : ''}
            })(
              <Select
                allowClear
                labelInValue
          ...
          <Form.Item label="状态:">
            {getFieldDecorator("state", {
              ...
              initialValue: {key: state, value: state}
            })(
              <Select
                allowClear
                labelInValue
          ...
          <Form.Item label="技术服务文件:">
            {getFieldDecorator("techServiceFile", {
              rules: [{ required: true, message: "请上传合同" }],
              valuePropName: 'fileList',
              getValueFromEvent: this.normFile,
              initialValue: techServiceFile ? [{
                name: techServiceFile,
                uid: '-1',
                status: 'done'
              }] : []
            })(
...
export default Form.create({ name: "EditContractForm" })(EditContractForm);
